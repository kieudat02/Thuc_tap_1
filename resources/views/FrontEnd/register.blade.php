                        ...
                        <div class="account-login">
                            ...
                            <fieldset class="col2-set">
                                <div class="col-1 new-users"><strong>Đăng nhập</strong>
                                    <div class="content">
                                        <p>Bằng cách tạo một tài khoản với cửa hàng của chúng tôi, bạn sẽ có thể di chuyển qua quy trình thanh toán nhanh hơn, lưu trữ nhiều địa chỉ vận chuyển, xem và theo dõi đơn đặt hàng của bạn trong tài khoản của bạn và hơn thế nữa.</p>
                                ...
                                <div class="col-2 registered-users"><strong>Khách hàng đã đăng ký</strong>
                                    <form action="{{ route('logout.store') }}" method="post">
                                        @csrf
                                        <div class="content">
                                            <p>Nếu bạn có tài khoản với chúng tôi, xin vui lòng đăng nhập.</p>
                                            <ul class="form-list">
                                                <li>
